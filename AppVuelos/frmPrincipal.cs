...
namespace AppVuelos
{
    public partial class frmPrincipal : Form
    {
        ...
        {
            cargarFormulario(new frmClientes());
        }
        ...
        {
            cargarFormulario(new frmRepcliente());
        }
        ...
        private void clienteVueloToolStripMenuItem_Click(object sender, EventArgs e)
        {
            cargarFormulario(new frmRepClienteVuelo());
        }
    }
}
